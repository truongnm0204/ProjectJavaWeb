 ...
 * @author PC
 */
@WebServlet(name = "OrdersDetailController", urlPatterns = {"/OrderDetailURL"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("deleteOrderDetails")) {
                dao.removeOrderDetails(Integer.parseInt(request.getParameter("pid")));
           ...
           if (service.equals("updateOrderDetails")) {
                ...
                if (submit == null) {//show insert form
                    ...
                    Vector<OrderDetails> vector=
                            dao.get("select * from Products where ProductID="+pid);
